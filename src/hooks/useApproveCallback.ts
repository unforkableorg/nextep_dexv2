...
import { Trade, WCXS, TokenAmount } from '@uniswap/sdk'
...
export function useApproveCallback(
  ...
  const approval = useMemo(() => {
    ...
    // we treat WCXS as CXS which requires no approvals
    if (amountToApprove.token.equals(WCXS[amountToApprove.token.chainId])) return ApprovalState.APPROVED

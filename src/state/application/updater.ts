...
export default function Updater() {
  ...
  const pairBetween = usePair(new Token(chainId? chainId: 785,"0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2", 18, "CXS", "Wrapped CXS" ), new Token(chainId? chainId: 785, "0x432E4997060F2385Bdb32cDc8Be815C6b22a8a61", 18, "NEXTEP", "NEXTEP"))
